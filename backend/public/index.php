...
if (version_compare(PHP_VERSION, '8.2.0', '<')) {
    ...
    echo '<!DOCTYPE html><html><head><meta charset="utf-8"><title>ACTI Edge Gateway (AEG) — PHP upgrade required</title>
    ...
    <p>ACTI Edge Gateway requires <strong>PHP 8.2 or higher</strong>.</p>
...
if (!file_exists(__DIR__.'/../vendor/autoload.php')) {
    http_response_code(503);
    echo '<!DOCTYPE html><html><head><meta charset="utf-8"><title>ACTI Edge Gateway (AEG) — Setup required</title>
    <style>body{font-family:sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;background:#f3f4f6}
    .box{background:#fff;border-radius:8px;padding:40px;max-width:520px;box-shadow:0 2px 12px rgba(0,0,0,.1)}
    ...
    <h1>⚙️ ACTI Edge Gateway (AEG) — Setup required</h1>
