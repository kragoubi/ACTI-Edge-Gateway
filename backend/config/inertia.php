...
return [
    ...
    */
    ...
    |
    | NOTE: this project stores page components under `resources/js/Pages`
    | (capital "P"). The package default ships `js/pages` (lowercase), which
    | never resolves on case-sensitive filesystems (Linux/CI) and breaks
    | `assertInertia()->component()` page-existence checks. Keep the capital.
    |
    */
