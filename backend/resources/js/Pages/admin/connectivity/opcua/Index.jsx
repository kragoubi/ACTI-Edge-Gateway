            ...
            <div className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold text-om-ink">{__('OPC UA')}</h1>
                    ...
                    <Link
                        href="/admin/connectivity/opcua/create"
                ...
                {connections.length === 0 ? (
                    <div className="text-center py-16 text-om-faint">
                        ...
                        <Link href="/admin/connectivity/opcua/create" className="mt-2 inline-block text-om-accent hover:underline text-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                        {connections.map((conn) => (
                            ...
                            >
                                ...
                                {conn.endpoint_url && (
                                    <p className="text-xs text-om-faint font-mono truncate" title={conn.endpoint_url}>
                                        {conn.endpoint_url}
                                    </p>
                                )}
...
OpcuaIndex.layout = (page) => <AppLayout>{page}</AppLayout>;
